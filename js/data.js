...
const PRODUCTS = [
  // ——— Everyday & Just Because ———
  {
    ...
    photos: ["red-rose-bouquet.webp", "red-rose-vase.webp"],
    order: "buy",
    buyLink: "",
  },
  {
    ...
    photos: ["sunny-yellow-rose-arrangement.webp", "golden-tulip-garden.webp"],
    order: "buy",
    buyLink: "",
  },
  {
    ...
    photos: ["blush-garden-vase.webp", "peach-purple-garden.webp"],
    order: "buy",
    buyLink: "",
  ...
  },
  {
    ...
    photos: ["purple-birthday-basket.webp", "birthday-balloon-flowers.webp"],
    order: "buy",
    buyLink: "",
  },
  {
    ...
    photos: ["gerbera-garden-vase.webp", "white-lily-vase.webp"],
    order: "buy",
    buyLink: "",
  },
  {
    ...
    photos: ["peach-purple-garden.webp", "gerbera-garden-vase.webp", "jewel-tone-vase.webp", "blush-garden-vase.webp"],
    order: "custom",
    buyLink: "",
  },
  ...
  },
  {
    name: "Standing Spray",
    category: "sympathy",
    price: "From $150",   // PRICE PLACEHOLDER — confirm with Lisa
    ...
    photos: ["sympathy-sunflower-standing-2024.webp", "yellow-blue-standing-spray.webp", "sunflower-standing-spray.webp", "sympathy-standing-yellow.webp", "gallery-08.jpg"],
    order: "custom",
    buyLink: "",
    notice: SHOP.funeralOrderNote,
  ...
  },
  {
    ...
    photos: ["sympathy-wreath-pink.webp", "memory-heart.jpg", "gallery-10.jpg", "gallery-05.jpg"],
    order: "custom",
    buyLink: "",
    notice: SHOP.funeralOrderNote,
  ...
  },
  {
    ...
    photos: ["fresh-floral-cross.webp"],
    order: "custom",
    buyLink: "",
    notice: SHOP.funeralOrderNote,
  ...
  },
  {
    ...
    photos: ["blue-yellow-silk-cemetery.webp", "blue-yellow-silk-cemetery-2.webp", "cemetery-subscription.jpg", "cemetery-vase-flowers.jpg"],
    order: "custom",
    buyLink: "",
  ...
  },
  {
    ...
    photos: ["wooden-cross-keepsake.webp"],
  ...
  },
  {
    ...
    photos: ["memorial-wind-chime-detail.webp", "memorial-wind-chime-full.webp"],
    galleryKind: "inventory",
    order: "buy",
    buyLink: "",
  },
  {
    ...
    photos: ["memorial-lantern-flowers.webp", "memorial-lantern-white.webp"],
    galleryKind: "inventory",
    order: "buy",
    buyLink: "",
  },
  {
    ...
    photos: ["remembrance-keepsakes.webp", "friendship-cross-keepsakes.webp"],
    galleryKind: "inventory",
    order: "buy",
    buyLink: "",
  },
  ...
  // ——— Seasonal & Holiday ———
  {
    ...
    photos: ["dusty-rose-corsage.webp", "white-lily-boutonniere.webp", "blush-rose-corsage.webp", "gallery-11.jpg"],
    order: "custom",
    buyLink: "",
  ...
  // ——— Gifts & Extras ———
  {
    ...
    photos: ["ladybug-dish-garden.webp", "peace-lily-memorial-garden.webp", "mixed-plant-basket.webp", "peach-plant-garden.webp", "plants-dish-gardens-2.jpg"],
    order: "buy",
    buyLink: "",
  },
  {
...
const GALLERY = [
  ...
  { image: "sympathy-sunflower-standing-2024.webp", caption: "A tall sunflower standing spray with blue accents", tag: "Sympathy" },
  ...
  { image: "blush-rose-corsage.webp", caption: "A blush rose corsage designed to coordinate with the dress", tag: "Prom & Seasonal" },
